...
import { B as BetterAuthOptions, i as InferUser, j as InferSession, G as GenericEndpointContext, H as HookEndpointContext } from '../../shared/better-auth.BNm-Id9Y.mjs';
