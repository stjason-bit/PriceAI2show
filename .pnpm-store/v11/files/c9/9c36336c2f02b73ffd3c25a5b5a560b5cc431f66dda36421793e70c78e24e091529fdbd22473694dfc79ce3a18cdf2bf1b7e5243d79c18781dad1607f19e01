...
import { G as GenericEndpointContext, B as BetterAuthOptions, h as AuthContext } from '../shared/better-auth.BWDlmABj.cjs';
export { z as AuthEndpoint, D as AuthMiddleware, v as AuthPluginSchema, r as BetterAuthPlugin, I as InferOptionSchema, t as InferPluginErrorCodes, y as createAuthEndpoint, x as createAuthMiddleware, w as optionsMiddleware } from '../shared/better-auth.BWDlmABj.cjs';
...
export { A as API_KEY_TABLE_NAME, E as ERROR_CODES, a as apiKey, d as defaultKeyHasher } from '../shared/better-auth.CxoVMW7L.cjs';
